...
// george collides with any of the cars
  ...
  //check if george made it to the finish line
  
  // if (george.position.x > 850 && george.position.x < 967 && george.position.y < 20) {
  if (george.position.y < 20 && georgeWon == false) {
    console.log("you won");
    win.play();
    storyBox.html("Yada Yada Yada!");
    georgeWon = true;
  }
